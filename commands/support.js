...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.com/invite/QAb6qNcQkN";
      const githubLink = "https://github.com/GlaceYT";
      const Instagram = "https://www.instagram.com/yuta.xae?igsh=MTVzenNodGt3MmE5cw==";
      const youtubeLink = "unknown";
        const embed = new EmbedBuilder()
            ...
            .setAuthor({
              ...
              url: 'https://discord.com/invite/QAb6qNcQkN'
          })
